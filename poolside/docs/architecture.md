...
| `self-test-footprint.cjs` | Footprint assertions for the packaged self-test: what a session *claims* to be, read back out of a |
...
| `target-identity.cjs` | The target half of a session footprint: the CDP overrides that make a *live page* claim a configured |
