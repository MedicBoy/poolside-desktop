...
const PURE_MODULES = [
  ...
  'timeline-engine.cjs',
  'timeline-query.cjs',
  'timeline-transfer.cjs',
  'dashboard-telemetry.cjs',
  'telemetry-redaction.cjs',
  'activity-journal.cjs',
  'workspace-history.cjs',
  'bulk-plan.cjs',
  'backup-manifest.cjs',
  'workspace-backup.cjs',
  'reading-status.cjs',
  'reading-regions.cjs',
  'settings-form-mapper.cjs',
  'settings-form-values.cjs',
  'settings-ui-controller.cjs',
