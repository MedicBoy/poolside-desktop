...
const CAPABILITIES = Object.freeze([
  ...
  },
  {
    ...
    flag: 'on',
    detail:
      'Pairs two of your own accounts into a match, records the result and keeps a bounded local ledger. It records what you decide: it does not pair accounts on the game service or verify a real match.'
  },
  {
    id: 'diagnostics',
