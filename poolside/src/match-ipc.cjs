...
/** @param {{handle: (name: string, fn: (input: any) => any) => void, matches: {start: Function, startRun: Function, stopRun: Function, complete: Function, cancel: Function, load: Function, view: Function}}} deps */
